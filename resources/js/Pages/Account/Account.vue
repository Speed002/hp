...
<template>
    <div>
        ...
        <form class="mt-10 space-y-6 w-96" v-on:submit.prevent="submit">
            <div>
            ...
            <div>
                <button type="submit" class="flex w-96 justify-center bg-blue-500 px-3 py-2 text-sm font-semibold text-white disabled:opacity-50" :disabled="form.processing">
                    Update
                </button>
            </div>
        </form>
